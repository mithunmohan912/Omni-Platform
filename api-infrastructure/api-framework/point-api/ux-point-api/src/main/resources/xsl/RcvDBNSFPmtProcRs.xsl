...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="POINTXML/RCV_PYMT_ADJ_INFO_ROW">
		...
		<POINTXML>
			...
			<ENTRYDATE><xsl:value-of select="PYMT_ADJ_HDR_ROW/HDR_ENTRY_DATE" /></ENTRYDATE>
			<PAYMTAMT><xsl:value-of select="PYMT_ADJ_HDR_ROW/HDR_PYMT_AMT" /></PAYMTAMT>
			<CHECKNUM><xsl:value-of select="PYMT_ADJ_HDR_ROW/HDR_CHK_NUM" /></CHECKNUM>
			<PAYBY><xsl:value-of select="PYMT_ADJ_HDR_ROW/HDR_PAY_BY" /></PAYBY>
			<HDR_LOC><xsl:value-of select="PYMT_ADJ_HDR_ROW/HDR_LOC" /></HDR_LOC>
			<HDR_ORIG_WRT_DTE><xsl:value-of select="PYMT_ADJ_HDR_ROW/HDR_ORIG_WRT_DTE" /></HDR_ORIG_WRT_DTE>
			<HDR_ORIG_REC_SEQ><xsl:value-of select="PYMT_ADJ_HDR_ROW/HDR_ORIG_REC_SEQ" /></HDR_ORIG_REC_SEQ>
			...
			<HDR_PYMT_AMT><xsl:value-of select="PYMT_ADJ_HDR_ROW/HDR_PYMT_AMT" /></HDR_PYMT_AMT>
			<HDR_CUST_NO><xsl:value-of select="PYMT_ADJ_HDR_ROW/HDR_CUST_NO" /></HDR_CUST_NO>
