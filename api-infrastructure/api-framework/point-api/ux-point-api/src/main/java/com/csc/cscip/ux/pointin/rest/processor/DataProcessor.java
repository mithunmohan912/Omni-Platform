...
public class DataProcessor extends AbstractServiceProcessor<Map<String, Object>, Map<String, Object>> {
	...
	public Object produceRequest(Map requestPayLoad, ServiceProcessorCallback callback) throws Throwable {
		if(UnderwritingProcessor.isRulesIntegrated()){
			requestPayLoad.put("rulesIntegrated", "Y");
		}
