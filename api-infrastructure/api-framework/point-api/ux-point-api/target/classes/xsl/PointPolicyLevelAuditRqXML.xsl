					...
					<PayLoad>
						<WC_AUDIT_CLASS_EXP_RECORDS_ROW>
							...
							<PROCESSING_INFO>
								...
								<PROC_EFFECTIVE_DATE ><xsl:value-of select="KEY_AUDIT_EFFECTIVE_DATE" /></PROC_EFFECTIVE_DATE>
								...
								<PROC_LDA_TRANSSEQ>0</PROC_LDA_TRANSSEQ>
								<PROC_LDA_ISSUE_CODE />
							...
							<xsl:for-each select="list/PayLoad">
								...
								<WC_AUD_EXPOSURE_ROW>
									...
									<A_EMP_SITE_NAME><xsl:value-of select="A_EMP_SITE_NAME" /></A_EMP_SITE_NAME>
								</WC_AUD_EXPOSURE_ROW>
								...
								<WC_COMMON_FIELDS_ROW>
									<COM_STATUS_DESCRIPTION><xsl:value-of select="COM_STATUS_DESCRIPTION" /></COM_STATUS_DESCRIPTION>
									...
									<COM_REQUEST_CODE>WCVAUDITCHGRq</COM_REQUEST_CODE>
									<COM_LOB_DESCRIPTION/>
