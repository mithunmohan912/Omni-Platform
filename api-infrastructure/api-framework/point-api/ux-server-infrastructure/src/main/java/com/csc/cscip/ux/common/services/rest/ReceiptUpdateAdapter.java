...
public class ReceiptUpdateAdapter {

	public ReceiptUpdateAdapter() {
	}

	public String receiptUpdateService(String requestXML, String serviceOperationName) throws Exception {
