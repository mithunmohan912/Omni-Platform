...
public class UnidentifiedCashInquireAdapter {

	public UnidentifiedCashInquireAdapter(){
		// TODO Auto-generated constructor stub
	}
	
	public String unidentifiedCashInquireService(String requestXML, String eeProperties) throws Exception {
	...
	public String unidentifiedDetail(String requestXML, String serviceOperationName) throws Exception {
