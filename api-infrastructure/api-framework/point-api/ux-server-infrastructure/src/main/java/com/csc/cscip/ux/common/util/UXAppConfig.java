...
public class UXAppConfig {
	...
	public static final String RULES_DATA_IMPORT_SOURCE_TYPE = "RulesDataImportSourceType";
	public static final String RULES_DATA_IMPORT_SOURCE_URI = "RulesDataImportSourceURI";
