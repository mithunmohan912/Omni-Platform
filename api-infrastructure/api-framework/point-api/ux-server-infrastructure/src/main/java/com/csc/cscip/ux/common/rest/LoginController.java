...
import com.csc.cscip.ux.common.security.securityengine.ACLHomeConfigManipulator;
/*ACL POC*/
...
public class LoginController extends AbstractRestController {
	...
	public PersonalizationDAO personalizationDAO = new PersonalizationDAO();
...
//		email = userInfo[3];
		...
		UserTransfer userTransfer = new UserTransfer(username, roles, TokenUtils.createToken(username, password), userPersonalization, LOC.toString(),
	...
	public String getPersonalizedApplications(String addedApps, String favExpOpt) throws Throwable {
		...
		/*ACL POC */
		//Map<String, Object> configMap = UXJacksonUtils.convertFromJSON(applications, Map.class);
		ACLHomeConfigManipulator.secureData(applications, "home:authenticate", "key", false);
		/*ACL POC */
