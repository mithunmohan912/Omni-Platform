...
<!-- Auto Generated XSLT for printer file DDS RCH4PF02-->
<xsl:template match="record[@name = 'ZAPAGHDR']" xml:space="preserve">
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre" >  <xsl:call-template name="Postpad"><xsl:with-param name="padVar"><xsl:value-of select="zapgm"/></xsl:with-param><xsl:with-param name="len">10</xsl:with-param><xsl:with-param name="padChar"> </xsl:with-param></xsl:call-template>              Deposit List By MCO                        Page  <fo:page-number/> </fo:block>
...
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre">                          <xsl:call-template name="Postpad"><xsl:with-param name="padVar"><xsl:value-of select="zbrvmftxt"/></xsl:with-param><xsl:with-param name="len">25</xsl:with-param><xsl:with-param name="padChar"> </xsl:with-param></xsl:call-template> </fo:block>
...
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre" >   <xsl:call-template name="Postpad"><xsl:with-param name="padVar"><xsl:value-of select="zcrvmitxt"/></xsl:with-param><xsl:with-param name="len">25</xsl:with-param><xsl:with-param name="padChar"> </xsl:with-param></xsl:call-template> </fo:block>
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre"> </fo:block>
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre">
</fo:block>
...
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre"> </fo:block>
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre">                     Batch Date                    Deposit Amount </fo:block>
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre">                     ----------                    -------------- </fo:block>
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre">
</fo:block>
...
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre" >                       <xsl:call-template name="cvtdateCYYMMDDtoMMDDYY"><xsl:with-param name="datefld"><xsl:call-template name="Prepad"><xsl:with-param name="padVar"><xsl:value-of select="vhbwrtdt"/></xsl:with-param><xsl:with-param name="len">6</xsl:with-param><xsl:with-param name="padChar">0</xsl:with-param></xsl:call-template></xsl:with-param></xsl:call-template>           <xsl:call-template name="Prepad"><xsl:with-param name="padVar"><xsl:value-of select="zhjuva"/></xsl:with-param>
...
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre" >      Total Master Company   <xsl:call-template name="Postpad"><xsl:with-param name="padVar"><xsl:value-of select="ziabcd"/></xsl:with-param><xsl:with-param name="len">2</xsl:with-param><xsl:with-param name="padChar"> </xsl:with-param></xsl:call-template> ......... <xsl:call-template name="Prepad"><xsl:with-param name="padVar"><xsl:value-of select="zijuva"/></xsl:with-param>
<!-- FSIT : 168489 Resolution : 59936 - Start -->
<!--<xsl:with-param name="len">10</xsl:with-param>-->
<xsl:with-param name="len">20</xsl:with-param>
<!-- FSIT : 168489 Resolution : 59936 - End -->
...
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre" >      Total Location Company <xsl:call-template name="Postpad"><xsl:with-param name="padVar"><xsl:value-of select="zjaacd"/></xsl:with-param><xsl:with-param name="len">2</xsl:with-param><xsl:with-param name="padChar"> </xsl:with-param></xsl:call-template> ......... <xsl:call-template name="Prepad"><xsl:with-param name="padVar"><xsl:value-of select="zjjuva"/></xsl:with-param>
<!-- FSIT : 168489 Resolution : 59936 - Start -->
<!--<xsl:with-param name="len">10</xsl:with-param>-->
<xsl:with-param name="len">20</xsl:with-param>
<!-- FSIT : 168489 Resolution : 59936 - End -->
...
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre" >                   Final Totals ......... <xsl:call-template name="Prepad"><xsl:with-param name="padVar"><xsl:value-of select="zkjuva"/></xsl:with-param>
<!-- FSIT : 168489 Resolution : 59936 - Start -->
<!--<xsl:with-param name="len">10</xsl:with-param>-->
<xsl:with-param name="len">20</xsl:with-param>
<!-- FSIT : 168489 Resolution : 59936 - End -->
