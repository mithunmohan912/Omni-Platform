...
<fo:block text-align="left" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre"> BASRETR03                    MODIFIED TREATIES WITH CHANGE TYPE 'R' AND ASSOCIATED POLICY LIST-REPORT                 PAGE:<fo:page-number/>/<fo:page-number-citation-last ref-id="last-page"/></fo:block>
</xsl:template>
...
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre"> LOC  MCO  SYMBOL  POLICY NO  MODULE </fo:block>
<fo:block text-align="justify" font-size="9pt" font-family="monospace" line-height="9pt" white-space="pre"> ------------------------------------- </fo:block>
</xsl:template>
