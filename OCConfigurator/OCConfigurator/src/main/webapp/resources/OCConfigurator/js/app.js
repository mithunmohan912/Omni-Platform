...
var app = angular.module('ux', ['ui.slider','ui.bootstrap','ngGrid','ngResource']). 
    config(['$routeProvider', function($routeProvider) {
        ...
        when('/designGrids', {templateUrl: 'partials/OCConfigurator-grid.html', controller: GridDesignCtrl}).
        when('/designGrids/:gridId', {templateUrl: 'partials/OCConfigurator-grid.html', controller: GridDesignCtrl}).
