...
public class UnidentifiedCashUpdateAdapter {

	public UnidentifiedCashUpdateAdapter(){
		// TODO Auto-generated constructor stub
	}
	
	public String unidentifiedCashUpdateService(String requestXML, String eeProperties) throws Exception {
	...
	public String unidentifiedCashUpdate(String requestXML, String serviceOperationName) throws Exception {
