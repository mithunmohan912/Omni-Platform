...
public class AccountUpdateAdapter {

    public AccountUpdateAdapter() {
	// TODO Auto-generated constructor stub
    }

    public String accountUpdateService(String requestXML, String serviceOperationName) throws Exception {
